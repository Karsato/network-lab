## 1. IDENTIDAD
uci set system.@system[0].hostname='L2R3'
uci commit system
...
uci set network.wan.ipaddr='10.11.2.2'
uci set network.wan.netmask='255.255.255.0'
uci set network.wan.gateway='10.11.2.1'
...
uci set network.lan1.ipaddr='10.23.1.1'
...
uci set network.lan2.ipaddr='10.23.2.1'
...
uci set network.lan3.ipaddr='10.23.3.1'
